...
function testBasics() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const product1 = { name: "Patient Kit", description: "Kit for treating TB", id: "product1" };
        const product2 = { name: "Patient Kit II", description: "Kit for treating TB with kit 2", id: "product2" };
        const product3 = { name: "Product IV", description: "Description for product 3", id: "product3" };
        const abuadFacility = {
            facility: {
                type: 'FACILITY',
                name: "ABUAD",
        ...
        yield (0, getter_1.getAllUserSupplies)(user1.id);
        yield (0, getter_1.getAllUserSupplies)(user2.id);
    });
}
exports.testBasics = testBasics;
// create facility
// create produts
// create 10 people
// create state
